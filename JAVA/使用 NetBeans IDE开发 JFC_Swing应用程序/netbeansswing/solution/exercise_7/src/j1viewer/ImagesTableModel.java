...
public class ImagesTableModel
    ...
    protected int scale = THUMBNAIL_SIZE;
    ...
    public class _ImageTablePanel extends JPanel {
        ...
        public _ImageTablePanel(String f, Toolkit toolkit) {
            ...
            if (w >= h) {
                img = img.getScaledInstance(scale, -1, Image.SCALE_FAST);
            } else {
                img = img.getScaledInstance(-1, scale, Image.SCALE_FAST);
            }
    ...
    public ImagesTableModel(String n) {   
        this (n, THUMBNAIL_SIZE);
    }
        
    public ImagesTableModel(String n, int s) {         
        dirname = n;
        scale = s;
